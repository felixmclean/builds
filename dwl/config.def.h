...
static const char *fonts[]                 = {"DejaVu Sans:style=Bold:size=16"};
...
static const double accel_speed = 0.00;
...
static const char *music[] 	    = { "spotify-launcher", "--", "--ozone-platform=wayland", NULL };
static const char *passwords[]      = { "env", "QT_QPA_PLATFORM=wayland", "keepassxc", "/home/felix/Documents/KeePass/Passwords.kdbx", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_o,    	  spawn, 	    {.v = obsidian } },
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_f,  	  spawn,	    {.v = files } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_question,    spawn, 	    {.v = passwords } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_d,		  spawn,	    {.v = discord } },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_m,		  spawn,	    {.v = music } },
